...
copy /Y ".\bin\Release\net8.0-windows\win-x86\publish\FT600DataLoopbackDemoApp.exe" ".\FT600DataLoopbackDemoApp.exe"

signtool sign /debug /v /s MY /a /n "Future Technology Devices International Ltd" /fd sha256 /tr http://timestamp.digicert.com /td sha256 /as FT600DataLoopbackDemoApp.exe
